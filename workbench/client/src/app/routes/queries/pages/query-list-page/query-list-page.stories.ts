...
import { QueryListPageComponent } from './query-list-page.component';

type StoryType = QueryListPageComponent;

const meta: Meta<StoryType> = {
  component: QueryListPageComponent,
  title: 'pages/queries/QueryListPageComponent',
  // tags: ['autodocs'],
  decorators: [
    applicationConfig({
      providers: [
