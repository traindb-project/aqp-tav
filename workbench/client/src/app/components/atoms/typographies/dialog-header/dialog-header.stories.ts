...
type StoryType = DialogHeaderDirective;

const meta: Meta<StoryType> = {
  component: DialogHeaderDirective,
  title: 'atoms/typographies/DialogHeaderDirective',
  // tags: ['autodocs'],
  // decorators: [
  //   applicationConfig({
  //     providers: [
...
export const Default: Story = {
  ...
  render: (args) => {
    ...
    return {
      props,
      template: `<h1 etriDialogHeader>Dialog Header</h1>`
    };
  }
};
