...
import { TableCellsIconComponent } from './table-cells-icon.component';

type StoryType = TableCellsIconComponent;

const meta: Meta<StoryType> = {
  component: TableCellsIconComponent,
  title: 'atoms/icons/TableCellsIconComponent',
  tags: ['autodocs'],
  // decorators: [
  //   applicationConfig({
  //     providers: [
