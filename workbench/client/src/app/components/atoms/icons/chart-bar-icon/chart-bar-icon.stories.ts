...
import { ChartBarIconComponent } from './chart-bar-icon.component';

type StoryType = ChartBarIconComponent;

const meta: Meta<StoryType> = {
  component: ChartBarIconComponent,
  title: 'atoms/icons/ChartBarIconComponent',
  tags: ['autodocs'],
  // decorators: [
  //   applicationConfig({
  //     providers: [
