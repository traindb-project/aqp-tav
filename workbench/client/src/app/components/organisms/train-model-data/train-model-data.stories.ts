...
import { TrainModelDataComponent } from './train-model-data.component';

type StoryType = TrainModelDataComponent;

const meta: Meta<StoryType> = {
  component: TrainModelDataComponent,
  title: 'organisms/TrainModelDataComponent',
  // tags: ['autodocs'],
  // decorators: [
  //   applicationConfig({
  //     providers: [
