...
# Commented by wgkim 2023-04-17 2-2
# TestCase는 unittest 라이브러리의 테스트를 위한 클래스이다.
# Flask는 Werkzeug 라이브러리를 통해 테스트 클라이언트를 내장함.
# Unittest 참조링크 : https://www.daleseo.com/python-unittest-testcase/
# 테스팅 스켈레톤 참조링크 : https://flask-docs-kr.readthedocs.io/ko/latest/testing.html
class BaseTestCase(TestCase):
    def setUp(self):
        ...
        self.app_ctx.push()
        db.session.close()
        # Deleted by wgkim 2023-04-17 1: DB를 드랍하고 신규생성하는 코드 비활성화 
        # db.drop_all()
        # db.create_all()
