...
# Commented by wgkim 2023-04-17 2-1
# 테스트 코드는 Given-When-Then 형태의 3단 구조를 가짐
class TestQueryResourceGet(BaseTestCase):
    ...
    def test_get_all_queries(self):
        # Commented by wgkim 2023-04-17 2-3
        # Given의 경우 주로 facotry 에서 필요한 환경을 작성
        # 현재 우리는 사용자, 기관, 그룹, 데이터소스 4개의 정보를 설정할 수 있어야 함.
