...
export const Columns = {
  // Added by wgkim 2023-05-22 : 체크박스 형태의 컬럼 추가
  checkbox(overrides) {
    // let handleCheckboxChange = overrides.handleCheckboxChange
    return extend(
      {
        width: "1%",
        // render: (text, item) => <Checkbox item={item} onChange={handleCheckboxChange()}
        render: (text, item) => <Checkbox item={item}/>,
      },
      overrides
    );
  },
