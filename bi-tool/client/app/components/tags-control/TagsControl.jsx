...
// Added by wgkim 2023-04-25 : 워크벤치 태그 컨트롤 생성
export const WorkbenchTagsControl = modelTagsControl({
  archivedTooltip: "This workbench is archived and can't be used in dashboards, or appear in search results.",
});
