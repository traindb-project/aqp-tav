...
import "./WorkbenchEditorControls.less";
import AutoLimitCheckbox from "@/components/tdb-workbenches/WorkbenchEditor/AutoLimitCheckbox";
...
export default function EditorControl({
  ...
  return (
    <div className="workbench-editor-controls">
      ...
      {dataSourceSelectorProps === false && <span className="workbench-editor-controls-spacer" />}
      ...
      {saveButtonProps !== false && (
        <ButtonTooltip title={saveButtonProps.title} shortcut={saveButtonProps.shortcut}>
          <Button
            className="workbench-editor-controls-button m-l-5"
            disabled={saveButtonProps.disabled}
            loading={saveButtonProps.loading}
            onClick={saveButtonProps.onClick}
            data-test="SaveButton">
            {!saveButtonProps.loading && <span className="fa fa-wrench" />}
