...
function useNavbarActiveState() {
  ...
  return useMemo(
    () => ({
      ...
      // TODO wgkim 2023-04-13 : 신규 라우팅에대한 버튼 활성화를 위한 작업
      // Updated by wgkim 2023-10-19 : 워크벤치 링크 변경
      workbench: includes(
        [
          "Workbench.List",
          "Workbench.Favorites",
  ...
  return (
    <nav className="desktop-navbar">
      ...
      <NavbarSection>
        ...
        {/* TODO wgkim 2023-04-13 : edit workbench로 권한 변경 */}
        {/* Updated by wgkim 2023-10-19 : workbeches -> workbench 권한 변경 */}
        {currentUser.hasPermission("view_query") && (
          <Menu.Item key="workbench" className={activeState.workbench ? "navbar-active-item" : null}>
            <Link href="workbench">
              <ToolOutlined aria-label="Workbench navigation button" />
              <span className="desktop-navbar-label">Workbench</span>
            </Link>
          </Menu.Item>
        )}
      </NavbarSection>
