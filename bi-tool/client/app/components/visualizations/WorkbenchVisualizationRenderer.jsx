// Updated by wgkim 2023-05-03 : 워크벤치용 렌더러
...
export default function VisualizationRenderer(props) {
  const data = useWorkbenchResultData(props.workbenchResult);
  ...
  // Reset local filters when workbench results updated
  useEffect(() => {
...
VisualizationRenderer.propTypes = {
  ...
  context: PropTypes.oneOf(["workbench", "widget"]).isRequired,
};
