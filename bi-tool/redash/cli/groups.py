...
# TODO wgkim 2023-04-13 : edit workbench 재기동 후 권한 추가되었는지 확인
@manager.command()
@argument("name")
@option(
    "--org",
...
@option(
    ...
    " 'schedule_query', 'list_dashboards', 'list_alerts', 'edit_workbench',"
...
@option(
    ...
    help="Comma separated list of permissions ('create_dashboard',"
    " 'create_query', 'edit_dashboard', 'edit_query',"
    " 'view_query', 'view_source', 'execute_query', 'list_users', 'edit_workbench',"
