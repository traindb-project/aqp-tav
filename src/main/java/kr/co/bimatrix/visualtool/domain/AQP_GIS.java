...
public class AQP_GIS {
    ...
    @Builder
    public AQP_GIS(Date date, Long time_code, Long zip_code, Long business_category_code, Long commercial_area_code, Long sales_count, Long sales_amount, Long temperature, Long humidity, Long precipitation, Long wind_direction, Long wind_speed, Long floating_population) {
        this.date = date;
